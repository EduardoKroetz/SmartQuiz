...
public class GetQuizByIdUseCase
{
    ...
    public async Task<ResultDto> Execute(Guid id)
    {
        ...
        var quizDto = new GetQuizDto(quiz.Id, quiz.Title, quiz.Description, quiz.Expires, quiz.ExpiresInSeconds, quiz.IsActive, quiz.Theme, quiz.Questions.Count, quiz.Difficulty, quiz.UserId);
